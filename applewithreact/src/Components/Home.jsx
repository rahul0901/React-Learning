        ...
        <div className="body-content-4">
          <div className="bc-41">
            <div className="bc-4-text-1">
              <h2>iPad Pro</h2>
              <h3>Supercharged by <img src="https://www.apple.com/v/home/be/images/logos/ipad-pro/promo_m2_chip__enw2kz91lsuq_small_2x.png" alt="" /></h3>
              <div className="bc-4-two-cta-1">
                <a>Learn more <i class="fa-solid fa-greater-than"></i></a>
                <a>Buy <i class="fa-solid fa-greater-than"></i></a>
              </div>
            </div>
